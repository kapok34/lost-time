...
export const translations: Record<UILang, Record<string, string>> = {
  en: {
    ...
    "apply.locationPlaceholder": "city, country",
    ...
    "apply.error.answerLength": "each answer must be between 3 and 200 characters.",
  ...
  fr: {
    ...
    "apply.location": "lieu",
    "apply.locationPlaceholder": "ville, pays",
    "apply.questionnaire": "questionnaire",
    ...
    "conversation.limitReached": "Vous avez atteint la limite de messages pour cette conversation.",
