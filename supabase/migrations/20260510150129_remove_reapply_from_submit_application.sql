-- Remove obsolete reapply logic from submit_application RPC.
-- Since rejected users are now fully deleted by the reject-applicant edge
-- function, there are no 'rejected' profiles to reset. Any existing profile
-- should block re-submission.
