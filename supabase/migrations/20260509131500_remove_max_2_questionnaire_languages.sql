-- Fix: remove the maximum 2 questionnaire languages limit from submit_application
-- Previous migration already had the limit removed in the source file, but it had
-- been applied to the database before the fix. This migration ensures the live
-- function is updated.
