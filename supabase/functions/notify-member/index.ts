...
export async function handler(req: Request): Promise<Response> {
  ...
  const t = {
    en: {
      subject: `new message from member no.${senderNum}`,
      greeting: "Hello,",
      received: `You have received a new message from <strong style="color: #800000;">member no.${senderNum}</strong>:`,
      openLink: "open correspondence",
      respondWarning: `Member no.${senderNum} may end this correspondence if you do not reply within 34 hours.`,
    ...
    fr: {
      ...
      greeting: "Bonjour,",
      received: `Tu as reçu un nouveau message de la part du <strong style="color: #800000;">membre n°${senderNum}</strong> :`,
      openLink: "ouvrir la correspondance",
      respondWarning: `Sans réponse de ta part sous 34 heures, membre n°${senderNum} pourra mettre fin à cette correspondance.`,
      endRule: "Tu ne peux mettre fin à cette correspondance qu'après avoir répondu.",
      brand: "— lost time",
    },
    it: {
      subject: `nuovo messaggio dal socio n°${senderNum}`,
      greeting: "Ciao,",
      received: `Hai ricevuto un nuovo messaggio da <strong style="color: #800000;">socio n°${senderNum}</strong>:` ,
      openLink: "apri la corrispondenza",
      respondWarning: `Se non rispondi entro 34 ore, socio n°${senderNum} potrà terminare questa corrispondenza.`,
