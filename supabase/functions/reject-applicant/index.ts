...
serve(async (req) => {
  ...
  const t = {
    en: {
      ...
      reasonLabel: "  ",
      outro: "Feel free to write to admin@lost-time.org if you have any questions. Godspeed!",
      signoff: "Yours truly,",
      brand: "— lost time",
    },
    fr: {
    ...
    it: {
      ...
      reasonLabel: "  ",
      outro: "Scrivici a admin@lost-time.org per qualsiasi domanda. Buona ricerca!",
      signoff: "Saluti,",
      brand: "— lost time",
    },
  }[lang];
